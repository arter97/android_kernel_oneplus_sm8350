...
static struct clk_vdd_class *gcc_bengal_regulators[] = {
	&vdd_cx,
	&vdd_mx,
};
...
static const struct pll_vco alpha_vco[] = {
...
static const struct qcom_cc_desc gcc_bengal_desc = {
	...
	.clk_regulators = gcc_bengal_regulators,
	.num_clk_regulators = ARRAY_SIZE(gcc_bengal_regulators),
};
...
static int gcc_bengal_probe(struct platform_device *pdev)
{
	 ...
	 * GCC_SYS_NOC_CPUSS_AHB_CLK, GCC_GPU_IREF_CLK
	 */
...
static void gcc_bengal_sync_state(struct device *dev)
{
	qcom_cc_sync_state(dev, &gcc_bengal_desc);
}
...
static struct platform_driver gcc_bengal_driver = {
	...
	.driver = {
		...
		.sync_state = gcc_bengal_sync_state,
	},
};
