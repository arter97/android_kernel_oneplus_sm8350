...
#include <dt-bindings/clock/qcom,dispcc-direwolf.h>
...
static struct clk_vdd_class *disp_cc_0_direwolf_regulators[] = {
	&vdd_mm,
};
...
enum {
	...
	P_DISP0_CC_PLL0_OUT_MAIN,
	P_DISP0_CC_PLL1_OUT_EVEN,
	P_DISP0_CC_PLL1_OUT_MAIN,
	P_DISP0_CC_PLL2_OUT_MAIN,
	P_SLEEP_CLK,
};
...
static struct alpha_pll_config disp0_cc_pll0_config = {
	.l = 0x4E,
	.alpha = 0x2000,
...
static struct alpha_pll_config disp0_cc_pll1_config = {
	.l = 0x1F,
	.alpha = 0x4000,
	.config_ctl_val = 0x20485699,
	.config_ctl_hi_val = 0x00002261,
...
static const struct clk_div_table post_div_table_disp0_cc_pll1_out_even[] = {
	{ 0x1, 2 },
	{ }
};
...
static struct clk_alpha_pll_postdiv disp0_cc_pll1_out_even = {
	.offset = 0x1000,
	.post_div_shift = 8,
	.post_div_table = post_div_table_disp0_cc_pll1_out_even,
	.num_post_div = ARRAY_SIZE(post_div_table_disp0_cc_pll1_out_even),
	.width = 4,
	.regs = clk_alpha_pll_regs[CLK_ALPHA_PLL_TYPE_LUCID_5LPE],
...
static struct alpha_pll_config disp0_cc_pll2_config = {
	.l = 0x46,
	.alpha = 0x5000,
	.config_ctl_val = 0x20485699,
	.config_ctl_hi_val = 0x00002261,
...
static const struct parent_map disp_cc_0_parent_map_5[] = {
	{ P_BI_TCXO, 0 },
	{ P_DISP0_CC_PLL0_OUT_MAIN, 1 },
	{ P_DISP0_CC_PLL1_OUT_MAIN, 4 },
	{ P_DISP0_CC_PLL2_OUT_MAIN, 5 },
	{ P_DISP0_CC_PLL1_OUT_EVEN, 6 },
};
...
static const struct freq_tbl ftbl_disp0_cc_mdss_ahb_clk_src[] = {
	F(19200000, P_BI_TCXO, 1, 0, 0),
	F(37500000, P_DISP0_CC_PLL1_OUT_EVEN, 8, 0, 0),
	F(75000000, P_DISP0_CC_PLL1_OUT_MAIN, 8, 0, 0),
	{ }
};
...
static struct clk_rcg2 disp0_cc_mdss_ahb_clk_src = {
	...
	.freq_tbl = ftbl_disp0_cc_mdss_ahb_clk_src,
...
static const struct freq_tbl ftbl_disp0_cc_mdss_byte0_clk_src[] = {
	F(19200000, P_BI_TCXO, 1, 0, 0),
	{ }
};
...
static struct clk_rcg2 disp0_cc_mdss_dptx0_aux_clk_src = {
	...
	.freq_tbl = ftbl_disp0_cc_mdss_byte0_clk_src,
	.clkr.hw.init = &(struct clk_init_data){
...
static const struct freq_tbl ftbl_disp0_cc_mdss_mdp_clk_src[] = {
	F(19200000, P_BI_TCXO, 1, 0, 0),
	F(85714286, P_DISP0_CC_PLL1_OUT_MAIN, 7, 0, 0),
	F(100000000, P_DISP0_CC_PLL1_OUT_MAIN, 6, 0, 0),
	F(150000000, P_DISP0_CC_PLL1_OUT_MAIN, 4, 0, 0),
	F(200000000, P_DISP0_CC_PLL1_OUT_MAIN, 3, 0, 0),
	F(300000000, P_DISP0_CC_PLL1_OUT_MAIN, 2, 0, 0),
	F(375000000, P_DISP0_CC_PLL0_OUT_MAIN, 4, 0, 0),
	F(500000000, P_DISP0_CC_PLL0_OUT_MAIN, 3, 0, 0),
	F(600000000, P_DISP0_CC_PLL1_OUT_MAIN, 1, 0, 0),
	{ }
};
...
static struct clk_rcg2 disp0_cc_mdss_mdp_clk_src = {
	...
	.freq_tbl = ftbl_disp0_cc_mdss_mdp_clk_src,
	.enable_safe_config = true,
	.clkr.hw.init = &(struct clk_init_data){
...
static const struct freq_tbl ftbl_disp0_cc_mdss_rot_clk_src[] = {
	F(19200000, P_BI_TCXO, 1, 0, 0),
	F(200000000, P_DISP0_CC_PLL1_OUT_MAIN, 3, 0, 0),
	F(300000000, P_DISP0_CC_PLL1_OUT_MAIN, 2, 0, 0),
	F(375000000, P_DISP0_CC_PLL0_OUT_MAIN, 4, 0, 0),
...
static struct clk_rcg2 disp0_cc_mdss_rot_clk_src = {
	...
	.hid_width = 5,
	.parent_map = disp_cc_0_parent_map_5,
	.freq_tbl = ftbl_disp0_cc_mdss_rot_clk_src,
	.enable_safe_config = true,
	.clkr.hw.init = &(struct clk_init_data){
...
static const struct freq_tbl ftbl_disp0_cc_sleep_clk_src[] = {
...
static struct clk_rcg2 disp0_cc_sleep_clk_src = {
	...
	.freq_tbl = ftbl_disp0_cc_sleep_clk_src,
	.clkr.hw.init = &(struct clk_init_data){
...
static struct clk_rcg2 disp0_cc_xo_clk_src = {
	.cmd_rcgr = 0x6044,
	.mnd_width = 0,
	.hid_width = 5,
	.parent_map = disp_cc_0_parent_map_2,
...
static struct clk_branch disp0_cc_xo_clk = {
	.halt_reg = 0x605c,
	.halt_check = BRANCH_HALT,
	.clkr = {
		.enable_reg = 0x605c,
		.enable_mask = BIT(0),
		.hw.init = &(struct clk_init_data){
			.name = "disp0_cc_xo_clk",
			.parent_hws = (const struct clk_hw*[]){
				&disp0_cc_xo_clk_src.clkr.hw,
			},
			.num_parents = 1,
...
static struct clk_regmap *disp_cc_0_direwolf_clocks[] = {
	...
	[DISP_CC_XO_CLK] = &disp0_cc_xo_clk.clkr,
	[DISP_CC_XO_CLK_SRC] = &disp0_cc_xo_clk_src.clkr,
};

static const struct regmap_config disp_cc_0_direwolf_regmap_config = {
	.reg_bits = 32,
	.reg_stride = 4,
	.val_bits = 32,
...
static struct qcom_cc_desc disp_cc_0_direwolf_desc = {
	.config = &disp_cc_0_direwolf_regmap_config,
	.clks = disp_cc_0_direwolf_clocks,
	.num_clks = ARRAY_SIZE(disp_cc_0_direwolf_clocks),
	.clk_regulators = disp_cc_0_direwolf_regulators,
	.num_clk_regulators = ARRAY_SIZE(disp_cc_0_direwolf_regulators),
};

static const struct of_device_id disp_cc_0_direwolf_match_table[] = {
	{ .compatible = "qcom,direwolf-dispcc0" },
	{ }
};
MODULE_DEVICE_TABLE(of, disp_cc_0_direwolf_match_table);

static int disp_cc_0_direwolf_probe(struct platform_device *pdev)
{
	struct regmap *regmap;
	int ret;

	regmap = qcom_cc_map(pdev, &disp_cc_0_direwolf_desc);
	if (IS_ERR(regmap))
		return PTR_ERR(regmap);

	ret = qcom_cc_runtime_init(pdev, &disp_cc_0_direwolf_desc);
	if (ret)
		return ret;
	...
	clk_lucid_5lpe_pll_configure(&disp0_cc_pll0, regmap, &disp0_cc_pll0_config);
	clk_lucid_5lpe_pll_configure(&disp0_cc_pll1, regmap, &disp0_cc_pll1_config);
	clk_lucid_5lpe_pll_configure(&disp0_cc_pll2, regmap, &disp0_cc_pll2_config);

	ret = qcom_cc_really_probe(pdev, &disp_cc_0_direwolf_desc, regmap);
	if (ret) {
...
static void disp_cc_0_direwolf_sync_state(struct device *dev)
{
	qcom_cc_sync_state(dev, &disp_cc_0_direwolf_desc);
}

static const struct dev_pm_ops disp_cc_0_direwolf_pm_ops = {
	SET_RUNTIME_PM_OPS(qcom_cc_runtime_suspend, qcom_cc_runtime_resume, NULL)
	SET_SYSTEM_SLEEP_PM_OPS(pm_runtime_force_suspend,
				pm_runtime_force_resume)
};

static struct platform_driver disp_cc_0_direwolf_driver = {
	.probe = disp_cc_0_direwolf_probe,
	.driver = {
		.name = "disp_cc_0-direwolf",
		.of_match_table = disp_cc_0_direwolf_match_table,
		.sync_state = disp_cc_0_direwolf_sync_state,
		.pm = &disp_cc_0_direwolf_pm_ops,
	},
};

static int __init disp_cc_0_direwolf_init(void)
{
	return platform_driver_register(&disp_cc_0_direwolf_driver);
}
subsys_initcall(disp_cc_0_direwolf_init);

static void __exit disp_cc_0_direwolf_exit(void)
{
	platform_driver_unregister(&disp_cc_0_direwolf_driver);
}
module_exit(disp_cc_0_direwolf_exit);

MODULE_DESCRIPTION("QTI DISP_CC_0 DIREWOLF Driver");
