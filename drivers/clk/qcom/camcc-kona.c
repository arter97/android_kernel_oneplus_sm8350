...
static void cam_cc_kona_fixup_konav2(struct regmap *regmap)
{
	...
	cam_cc_ife_0_clk_src.clkr.vdd_data.rate_max[VDD_NOMINAL] = 680000000;
	cam_cc_ife_1_clk_src.freq_tbl = ftbl_cam_cc_ife_1_clk_src_kona_v2;
	cam_cc_ife_1_clk_src.clkr.vdd_data.rate_max[VDD_NOMINAL] = 680000000;
...
{
	qcom_cc_sync_state(dev, &cam_cc_kona_desc);
}

static const struct dev_pm_ops cam_cc_kona_pm_ops = {
