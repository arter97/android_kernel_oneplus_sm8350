...
static const struct pinctrl_pin_desc sdxnightjar_pins[] = {
...
static const struct msm_function sdxnightjar_functions[] = {
	FUNCTION(gpio),
	FUNCTION(uim2_data),
	FUNCTION(qdss_stm31),
	FUNCTION(ebi0_wrcdc),
...
static const struct msm_pingroup sdxnightjar_groups[] = {
...
static const struct msm_pinctrl_soc_data sdxnightjar_pinctrl = {
	...
	.functions = sdxnightjar_functions,
	.nfunctions = ARRAY_SIZE(sdxnightjar_functions),
...
{
	return msm_pinctrl_probe(pdev, &sdxnightjar_pinctrl);
}

static const struct of_device_id sdxnightjar_pinctrl_of_match[] = {
	{ .compatible = "qcom,sdxnightjar-pinctrl", },
	{ },
};

static struct platform_driver sdxnightjar_pinctrl_driver = {
	.driver = {
		.name = "sdxnightjar-pinctrl",
		.of_match_table = sdxnightjar_pinctrl_of_match,
	},
	.probe = sdxnightjar_pinctrl_probe,
	.remove = msm_pinctrl_remove,
};

static int __init sdxnightjar_pinctrl_init(void)
{
	return platform_driver_register(&sdxnightjar_pinctrl_driver);
}
arch_initcall(sdxnightjar_pinctrl_init);

static void __exit sdxnightjar_pinctrl_exit(void)
{
	platform_driver_unregister(&sdxnightjar_pinctrl_driver);
}
module_exit(sdxnightjar_pinctrl_exit);

MODULE_DESCRIPTION("QTI sdxnightjar pinctrl driver");
MODULE_LICENSE("GPL v2");
MODULE_DEVICE_TABLE(of, sdxnightjar_pinctrl_of_match);
