...
int ipa_fmwk_register_ipa(const struct ipa_core_data *in)
{
	...
	ipa_fmwk_ctx->ipa_tx_dp_mul = in->ipa_tx_dp_mul;
	...
	ipa_fmwk_ctx->ipa_uc_reg_rdyCB = in->ipa_uc_reg_rdyCB;
	ipa_fmwk_ctx->ipa_uc_dereg_rdyCB = in->ipa_uc_dereg_rdyCB;
		...
		struct ipa_tx_data_desc *data_desc)
{
	...
	IPA_FMWK_DISPATCH_RETURN(ipa_tx_dp_mul, src, data_desc);
...
int ipa_uc_reg_rdyCB(struct ipa_wdi_uc_ready_params *param)
{
	...
	IPA_FMWK_DISPATCH_RETURN(ipa_uc_reg_rdyCB, param);
...
int ipa_uc_dereg_rdyCB(void)
{
	...
	IPA_FMWK_DISPATCH_RETURN(ipa_uc_dereg_rdyCB);
