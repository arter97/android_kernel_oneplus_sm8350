...
#define SLAVE_APSS_THROTTLE_CFG				516
...
#define SLAVE_DISPLAY_CFG				529
#define SLAVE_DISPLAY_THROTTLE_CFG				530
#define SLAVE_GPU_CFG				531
#define SLAVE_GPU_THROTTLE_CFG				532
#define SLAVE_HWKM_CORE				533
